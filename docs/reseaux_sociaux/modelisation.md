...
??? success "Format PDF"
    [Télécharger activité en PDF](pdf/activite_modelisation.pdf)
...
{% if exercices.reseaux_sociaux.modelisation.exo1 %}
...
{% if exercices.reseaux_sociaux.modelisation.exo2 %}
...
{% if exercices.reseaux_sociaux.modelisation.exo3 %}
...
{% if exercices.reseaux_sociaux.modelisation.exo4 %}
...
{% if exercices.reseaux_sociaux.modelisation.exo5 %}
