...
!!! note "Manipulation à faire"
    **Ouvrir** le **menu d'options** de **Firefox** en cliquant sur l'icône rayée :material-menu: en **haut à droite** de la **barre de menu**, puis sélectionner **Paramètres** dans le menu déroulant :
    ...
    <center>
    ![Firefox menu latéral](images/Firefox_Menu_Lateral_1.png){ width="300px" }
    </center>
    ...
    <figure markdown>
    <center>
    ![Firefox menu gauche](images/Firefox_Menu_Gauche.png){ width="150" }
    </center>
...
!!! note "Manipulation finale à faire"
    ...
    ![type:video](videos/Recherche_Firefox.mp4)
...
!!! note "À faire"
    ...
    <figure markdown>
    <center>
    ![Google - Préférences publicitaires](images/Google_pref_publicites.png){ width="300px" }
    </center>
